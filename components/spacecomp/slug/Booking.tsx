...
const BookingSummary = ({spaceData}: {spaceData: FullListingData}) => {
    ...
    return (
        <div className="md:col-span-1 ">
            <div className="sticky top-8 border rounded-none p-6 space-y-6">
                ...
                <div className="space-y-4">
                    <div className="flex flex-col gap-2">
                        <div className="relative w-full">
                            ...
                            <div
                                className="border mt-1 rounded-none py-3 px-2 cursor-pointer bg-white flex flex-row items-center gap-2 h-full w-full"
                        ...
                        <div className="flex flex-row gap-4 rounded-lg">
                            ...
                            <div className="flex flex-col w-full">
                                <div
                                    className={`flex items-center gap-2 border p-3 rounded-md  ${!startTime ? "opacity-50 cursor-not-allowed" : ""
                                        }`}
                                >
                                    <Clock className="h-4 w-4 text-gray-500" />
                                    <select
                    ...
                    <div className="border rounded-lg p-3">
                        ...
                        {selectedOption === "custom" && (
                            <input
                                ...
                                onChange={(e) => setCustomAttendees(e.target.value? String(parseInt(e.target.value,10)):"")}
