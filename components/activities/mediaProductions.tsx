...
export default function MediaProductions() {
    ...
    const toggleAmenity = (amenity: Amenities) => {
        ...
        setValue("media.amenities", updatedAmenities);
    };
    ...
    const addCustomAmenity = () => {
        if (customAmenity.trim() !== "") {
            ...
            setValue("media.customAmenities", [...(selectCustomAmenities || []), customAmenity]);
            setCustomAmenity("");
        }
    };
    ...
    const toggleCustomAmenities = (amenity: string) => {
        ...
        setValue("media.customAmenities", updatedCustomAmenities);
    }
    return <>
        <div className="border-gray-300 border p-6  flex flex-col space-y-2 ">
            ...
            {!enabled ? (
                <div
                    ...
                    onClick={() => setValue("media.enabled",!enabled)}
                >
            ...
            {enabled && (
                <>
                        ...
                        <div className="flex flex-row ">
                            ...
                            <div className="rounded-none text-md  border w-1/2 h-10">
                                <input
                                    ...
                                    placeholder='1000'
                                    type='number'
                                    {...register("media.hourlyRate", { valueAsNumber: true })}
                                />
                            </div>
                        </div>
                        {errors.media?.hourlyRate && (
                            <span className="text-red-500 text-xs">{errors.media.hourlyRate.message}</span>
                        )}
                        ...
                        <div className="flex flex-row ">
                            ...
                            <div className="rounded-none text-md  border w-1/2 h-10">
                                <input
                                    ...
                                    placeholder='4'
                                    type='number'
                                    {...register("media.minimumHours", { valueAsNumber: true })}
                                />
                            </div>
                        </div>
                        {errors.media?.minimumHours && (
                            <span className="text-red-500 text-xs">{errors.media?.minimumHours.message}</span>
                        )}
                        ...
                        <div className="flex flex-row ">
                            <div className="rounded-none text-md  border w-1/2 h-10">
                                <input
                                    ...
                                    type='number'
                                    {...register("media.discount", { valueAsNumber: true })}
                                />
                            </div>
                    ...
                    {
                        errors.media?.discount && (
                            <span className="text-red-500 text-xs">{errors.media?.discount.message}</span>
                        )
                    }
                    ...
                    />
                    {
                        errors.media?.cleaningRate?.message && (
                            <span className="text-red-500 text-xs pt-2">{errors.media?.cleaningRate.message}</span>
                        )
                    }
                    {
                        showAdditonalFee && (
                                ...
                                <div className="flex flex-row pt-4">
                                    ...
                                    <div className="rounded-none text-md  border w-1/2 h-10">
                                        <input
                                            ...
                                            placeholder='1000'
                                            type='number'
                                            {...register("media.additionalFee", {
                                                valueAsNumber: true,
                                            })}
                                        />
                                    </div>
                                </div>
                                {errors.media?.additionalFee?.message && (
                                    <span className="text-red-500 text-xs pt-2">{errors.media.additionalFee.message}</span>
                                )}
                            </>
                        )
                    }
                    ...
                    {
                        errors.media?.instantBooking && (
                            <span className="text-red-500 text-xs pt-2">{errors.media.instantBooking.message}</span>
                        )
                    }
                    ...
                    <div className="flex flex-row ">
                        ...
                        <div className="rounded-none text-md  border w-1/2 h-10">
                            <input
                                ...
                                placeholder='250'
                                type='number'
                                {...register("media.capacity", { valueAsNumber: true })}
                            />
                        </div>
                    </div>
                    {
                        errors.media?.capacity && (
                            <span className="text-red-500 text-xs">{errors.media.capacity.message}</span>
                        )
                    }
                    ...
                    <span className="text-gray-500 gap-2 flex flex-wrap pb-4">You must include WiFi, tables, and chairs to offer medias</span>
                    {
                        errors.media?.amenities && (
                            <span className="text-red-500 text-xs pb-4">{errors.media?.amenities.message}</span>
                        )
                    }
                    {
